...
## Replicates
names(studyData)
ggplot(studyData, aes(x = as.numeric(n.sites))) + geom_density(fill="Grey50") + theme_Publication() + xlab("Number of sites") + ylab("Frequency of studies") + scale_x_continuous(trans =  "log2")

ggplot(studyData, aes(x = as.numeric(study.duration))) + geom_density(fill="Grey50") + theme_Publication() + xlab("Duration of study in years") + ylab("Frequency of studies")+ scale_x_continuous(trans =  "log2")
```

...
mp <- mp+ geom_point(data=gpsSplit %>%  filter(Grazer.status != "") , aes(x=Longitude, y=Latitude, color=Grazer.status), size=2, pch=19) + scale_color_manual(values=c("#D55E00", "#E69F00", "#56B4E9","grey50")) + ylab("Latitude") + xlab("Longitude") 
mp
